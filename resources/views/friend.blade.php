                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 pb-3">
                            <form id="DiscoverFriends" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div style="text-align: right; float: right;">
                                        <a id="search" class="TweetButton">Find!</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="row pt-5" id="tag_cloud_users">
                        ...
                        @else
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img class="rounded-circle" width="50" src="/storage/{{ $tag_users->profile->profileimage }}">
